...
const floor = new THREE.Mesh(
    ...
    new THREE.MeshStandardMaterial({
        ...
        oaMap: grassAmbientOcclusionTexture,
...
//     const randomScale = (Math.random() * (0.5 - 0.2)) + 0.2
//     tempBush.scale.set(randomScale, randomScale, randomScale)
//     tempBush.position.set(Math.floor(Math.random() * (9 - -9)) + -9, 0, Math.floor(Math.random() * (9 - -9)) + -10)
//     scene.add(tempBush)
...
// const pointHelper = new THREE.PointLightHelper(doorLight, 0.2)
// house.add(pointHelper)
...
const tick = () => {
    ...
    ghost3.position.y = Math.sin(elapsedTime * 3) + Math.sin(elapsedTime * 0.5)
